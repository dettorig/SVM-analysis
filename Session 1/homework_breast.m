% testset is N x 30, labels_total is N x 1
total = [testset; trainset];
...
[coeff, score, latent] = pca(total_std);  % PCA projection

% === Compute variance explained by each component ===
explained_variance = latent / sum(latent);  % Normalize eigenvalues
...
title('2D PCA Projection of Standardized Breast Dataset');
